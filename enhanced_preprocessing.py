...
class FeatureEngineer(BaseEstimator, TransformerMixin):
    ...
    def __init__(self, create_interactions=True, create_ratios=True, create_polynomials=False):
    ...
    def build_pipeline(self):
        ...
        if self.config['feature_engineering']['enabled']:
            feature_engineer = FeatureEngineer(
                create_interactions=self.config['feature_engineering'].get('create_interactions', True),
                create_ratios=self.config['feature_engineering'].get('create_ratios', True),
                create_polynomials=self.config['feature_engineering'].get('create_polynomials', False)
            )
...
def create_enhanced_preprocessing_config(task_type='classification', complexity='medium'):
    ...
    configs = {
        'simple': {
            'outlier_removal': {'enabled': True, 'method': 'iqr', 'threshold': 3.0},
            'feature_engineering': {'enabled': False, 'create_interactions': False, 'create_ratios': False, 'create_polynomials': False},
            'feature_selection': {'enabled': True, 'n_features': 30, 'methods': ['univariate']},
            'scaling': {'method': 'standard'}
        },
        'medium': {
            'outlier_removal': {'enabled': True, 'method': 'iqr', 'threshold': 3.0},
            'feature_engineering': {'enabled': True, 'create_interactions': True, 'create_ratios': False, 'create_polynomials': False},
            'feature_selection': {'enabled': True, 'n_features': 50, 'methods': ['univariate', 'mutual_info']},
            'scaling': {'method': 'robust'}
        },
        'complex': {
            'outlier_removal': {'enabled': True, 'method': 'iqr', 'threshold': 3.0},
            'feature_engineering': {'enabled': True, 'create_interactions': True, 'create_ratios': True, 'create_polynomials': False},
            'feature_selection': {'enabled': True, 'n_features': 80, 'methods': ['univariate', 'mutual_info', 'tree_importance']},
            'scaling': {'method': 'robust'}
        }
    }
